---
description: "List available commands and report them to the user"
---

# Help

List the available commands from ~/.config/opencode/agent/AGENTS.md and report them to the user.
