...
- Call: `Skill(skill: "specification-management")`
...
When a new spec directory was just created, ask where to
...
- Call: `Skill(skill: "requirements-analysis")`
...
- Call: `Skill(skill: "architecture-design")`
...
- Call: `Skill(skill: "constitution-validation")` in planning mode
...
- Call: `Skill(skill: "implementation-planning")`
...
- **Git integration is optional** - Call `Skill(skill: "git-workflow")` to offer branch creation (`spec/[id]-[name]`) and PR workflow
