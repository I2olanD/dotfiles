...
description: Build specifications, user journey maps, and story maps for product discovery and feature planning
license: MIT
...
- /generate [persona|journey|storymaps|userStories|feature] - Suggest items for the list
