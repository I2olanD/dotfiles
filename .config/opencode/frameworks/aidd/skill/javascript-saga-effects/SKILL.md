---
name: javascript-saga-effects
description: Isolate network I/O and side effects using saga pattern with call/put for deterministic testing
license: MIT
compatibility: opencode
---

# JavaScript Saga Effects Skill
...
- **Deterministic testing**: Test sagas without mocking network calls
- **Clear separation**: Side effects are isolated from business logic
- **Easy debugging**: Step through saga execution with `.next()`
- **Branch testing**: Test error paths by passing errors into `.throw()`
