...
Load `product-management` skill for UserJourney and Persona definitions.
...
Note: Journey YAML files use base Persona (meta fields only) from product-management skill.
